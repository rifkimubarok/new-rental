...
Please install and activate it before starting to use the theme Piqes.

Also the theme supports many popular plugins such as 'Elementor', 'WPBakery Builder'
and many more. They can be installed after theme activation from the menu 'Theme Panel->Theme Dashboard->Plugins'.


III. Documentation

Theme documentation is available on http://piqes.ancorathemes.com/doc/
...
2) Icons (css/font-icons/*.*)
   The icon set used in Piqes is Fontello.
